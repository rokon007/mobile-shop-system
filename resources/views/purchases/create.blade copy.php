                    ...
                    <form action="{{ route('purchases.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="discount_amount" id="discount_amount" class="form-control" value="{{ old('discount_amount', 0) }}" step="0.01" min="0">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="shipping_cost">Shipping Cost</label>
                                    <input type="number" name="shipping_cost" id="shipping_cost" class="form-control" value="{{ old('shipping_cost', 0) }}" step="0.01" min="0">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                        ...
                        <div id="purchase-items">
                            <div class="purchase-item row mb-3">
                                ...
                                <div class="col-md-3">
                                    <input type="number" name="products[0][quantity]" placeholder="Quantity" class="form-control" min="1" required>
                                </div>
                                <div class="col-md-3">
                                    <input type="number" name="products[0][unit_price]" placeholder="Unit Price" class="form-control" step="0.01" min="0" required>
                                </div>
                                <div class="col-md-2">
